...
public class PreconditionsTest extends TestCase {
    public void testPreconditionsTest(){
        try {
            getPersionByPrecondition(8, "pedia");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
            getPersionByPrecondition(-9, "pedia");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
            getPersionByPrecondition(8, "");
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        try {
            getPersionByPrecondition(8, null);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    public static void getPersionByPrecondition(int age, String name) throws Exception{
        Preconditions.checkNotNull(name,"name is null");
        Preconditions.checkArgument(name.length() > 0, "name is \'\'");
